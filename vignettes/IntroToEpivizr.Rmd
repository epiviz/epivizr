...
For a smaller file size, you may choose whether to include/exclude the data. 
...
This will recreate the workspace in your web browser and reconnect it with the R session.
